...
router.get("/oauth2callback", async (req, res) => {
  if (req.query.error) return res.redirect("https://dayze.herokuapp.com/#/user");
  ...
  res.redirect("https://dayze.herokuapp.com/#/user/granted"); // Now go to frontend   success page
});
